...
function login() {
  ...
  echo "Please open this url in a browser: $authzEndpoint?response_type=code&client_id=$client_id&redirect_uri=http://127.0.0.1:$port/&scope=$client_scope" #https://openid.net/specs/openid-connect-core-1_0.html#AuthRequest
