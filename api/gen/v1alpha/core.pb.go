...
type GetSeatsResponse struct {
	...
	Users       []*GetSeatsUserRepresentation `protobuf:"bytes,1,rep,name=users,proto3" json:"users,omitempty"`             //empty if includeUsers = false, filled if includeUsers=true
...
type GetSeatsCountResponse struct {
	...
	SeatsTotal     int32 `protobuf:"zigzag32,1,opt,name=seatsTotal,proto3" json:"seatsTotal,omitempty"`         //total seats.
	SeatsAvailable int32 `protobuf:"zigzag32,2,opt,name=seatsAvailable,proto3" json:"seatsAvailable,omitempty"` //currently available seats.
}
...
func (x *GetSeatsCountResponse) GetSeatsTotal() int32 {
	if x != nil {
		return x.SeatsTotal
	}
	return 0
...
func (x *GetSeatsCountResponse) GetSeatsAvailable() int32 {
	if x != nil {
...
var file_v1alpha_core_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x61, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x11, 0x52, 0x0a, 0x73, 0x65, 0x61, 0x74,
	0x73, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x12, 0x26, 0x0a, 0x0e, 0x73, 0x65, 0x61, 0x74, 0x73, 0x41,
	0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x6c, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x11, 0x52, 0x0e,
