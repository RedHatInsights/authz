...
const (
	umbUserEventsTopic string = "VirtualTopic.canonical.user" //Duplicated here for now because while it really belongs to the event package, it's used here too and can't be referenced both places without creating a cycle
)
